...
',43);
	 ...
	 */
t3lib_extMgm::addTypoScript($_EXTKEY,'editorcfg','
    tt_content.CSS_editor.ch.tx_tmdcinema_pi3 = < plugin.tx_tmdcinema_pi3.CSS_editor
',43);
t3lib_extMgm::addPItoST43($_EXTKEY,'pi3/class.tx_tmdcinema_pi3.php','_pi3','list_type',0);
t3lib_extMgm::addTypoScript($_EXTKEY,'setup','
    tt_content.shortcut.20.0.conf.tx_tmdcinema_program = < plugin.'.t3lib_extMgm::getCN($_EXTKEY).'_pi3
    tt_content.shortcut.20.0.conf.tx_tmdcinema_program.CMD = singleView
',43);
